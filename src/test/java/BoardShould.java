...
public class BoardShould {
  ...
  @Test
  public void stay_and_face_west_when_ant_is_in_a_black_case_and_face_north() {
    // given
    Board board = new Board();
    board.setBoard(new String[]{"b"});
    Ant ant = new Ant();
  ...
  @Test
  public void stay_and_face_south_when_ant_is_in_a_black_case_and_face_west() {
    // given
    Board board = new Board();
    board.setBoard(new String[]{"b"});
    Ant ant = new Ant();
  ...
  @Test
  public void stay_and_face_east_when_ant_is_in_a_black_case_and_face_south() {
    // given
    Board board = new Board();
    board.setBoard(new String[]{"b"});
    Ant ant = new Ant();
